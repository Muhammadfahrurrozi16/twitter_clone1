...
class Tweet{
  ...
  @override
  String toString() {
    return 'Tweet(text: $text, hastag: $hastag, link: $link, imageLinks: $imageLinks, uid: $uid, tweetType: $tweetType, tweetedAt: $tweetedAt, likes: $likes, comentsIds: $comentsIds, id: $id, reshareCount: $reshareCount, retweetedBy :$retweetedBy, repliedTo : $repliedTo)';
     }
